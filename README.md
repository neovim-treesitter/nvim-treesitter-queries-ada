# nvim-treesitter-queries-ada

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ada/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ada/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ada**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-ada",
...
- [ ] Changes are scoped to `ada` — do not include files for other languages
